...
# ./lwechal-bssa-est | tee bssa_result/beta-start-50/low-lwechal-bssa-est-sec.log
./lwechal-bssa-est | tee bssa_result/beta-start-50/unsolved-lwechal-bssa-est-sec-limRAM.log
