...
def Ratio_figure(dir,log_gs_length,sim_log_gs_lengths,n,dimension,alpha_,square_error1,Blocksize,Jump,N,test_number):
    ...
    plt.scatter(x, ratio1,s=24,marker="*",c='k',edgecolors='k', label='Real ||bi*||/ Sim ||bi*|| Tours=1')   
    plt.scatter(x, ratio4,s=16,marker="^",c='none',edgecolors='b', label='Real ||bi*||/ Sim ||bi*|| Tours=%d'%Current_Tours1)
    plt.scatter(x, ratio8,s=16,marker="o",c='r',edgecolors='r', label='Real ||bi*||/ Sim ||bi*|| Tours=%d'%Current_Tours2)
