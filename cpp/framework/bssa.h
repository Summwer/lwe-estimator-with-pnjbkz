...
class BSSA{
    public:
        ...
        bool pnjbkz_beta_loop( vector<double> &l, pair<double,double> &cum_GB, pair<double,double> &cum_avg_GB, double &cum_pr, int beta, int jump, tuple<int,int,double,double> &dsvp_t_, double &slope);
