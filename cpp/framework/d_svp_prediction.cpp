...
tuple<int,int,double,double> dsvp_predict(vector<double> l,  double cum_pr, COST* cost, int cost_model, bool progressive_sieve, bool worst_case, pair<double,double> cum_GB_BKZ ){
    /*
    return dsvp, G, B. 
    */
    if(progressive_sieve){
        if(cost->params-> est_model == 1)
            return progressive_dsvp_predict1(l, cum_pr, cost, cost_model, worst_case,cum_GB_BKZ);
        else if(cost->params-> est_model == 2)
            return progressive_dsvp_predict2(l, cum_pr, cost, cost_model,cum_GB_BKZ );
    }
...
tuple<int,int,double,double> progressive_dsvp_predict1(vector<double> l, double cum_pr, COST* cost, int cost_model, bool worst_case, pair<double,double> cum_GB_BKZ ){
    /*
    return dsvp, G, B. 
    */
    int d = l.size();
...
tuple<int,int,double,double> progressive_dsvp_predict2(vector<double> l, double cum_pr, COST* cost, int cost_model, pair<double,double> cum_GB_BKZ ){ //, bool worst_case
    /*
    return dsvp, G, B. 
    */
    int d = l.size();
...
tuple<int,int,double,double> progressive_dsvp_predict3(vector<double> l, double cum_pr, COST* cost, int cost_model, bool worst_case, pair<double,double> cum_GB_BKZ ){
    /*
    return dsvp, G, B. 
    */
    int d = l.size();
