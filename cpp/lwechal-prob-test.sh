...
./lwechal-enumbs-est 100 5 1 300 2 3 55 1 | tee "lwechal-prob-test"/"EnumBS-Strategy(cumprob+prob)+list decoding in [AGPS20](gate min).log"

./lwechal-enumbs-est 100 5 1 300 2 3 55 2 | tee "lwechal-prob-test"/"EnumBS-Strategy(cumprob+prob)+list decoding in [MATZOV22](gate min).log" 
