...
void sim_strategy(Params* params, vector<double> l, vector<tuple<int,int,int>> strategy, double sigma){
    ...
    for(int i = 0; i<int(strategy.size()); i++){
        ...
        for(int t = 0; t< tours; t++){
            ...
            if(params->verbose)
                printf("Strategy (%d,%d,%d), slope = %lf, pr = %e, l[dim-beta_] = %f, sim-cost = %3.7f log(sec), G_cum = %3.7f log(sec), G_BKZ = %3.7f log(sec)\n", beta,jump,t+1,slope, pr, l[dim-beta_],  G.first, Gcum, GBKZ );
...
int main(){
    ...
    //   {626,1,1}, {627,1,1}, {628,1,1}};
    //  {646,4,1}};
     
     //{615,1,1}, {616,1,1}, {617,1,1}, {618,1,1}, {619,1,1}, {620,1,1}, {621,1,1}, {622,1,1}, {623,1,1}, {624,1,1}, {625,1,1}, {626,1,1}, {627,1,1},{628,1,1}};
