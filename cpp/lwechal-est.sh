...
./lwechal-enumbs-est 100 5 2 300 2 3 50 | tee lwechal-est-result/"enumbs(32+2gpus)-d4f-default-g6k.log" #{{80, 0.005}}
...
./lwechal-bssa-est 100 5 2 300 1 0 3 1 50 | tee lwechal-est-result/"bssa(32+2gpus)-d4f-default-g6k.log"
