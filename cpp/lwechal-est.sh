...
./lwechal-enumbs-est 100 1 2 300 2 3 50 | tee lwechal-est-result/"enumbs(32+2gpus)-d4f-default-g6k-J=100-maxloop=1.log" #{{80, 0.005}}


./lwechal-enumbs-est 100 1 2 300 2 3 50 | tee lwechal-est-result/"enumbs(32+2gpus)-d4f-default-g6k-J=8-maxloop=5.log" #{{80, 0.005}}

# ./lwechal-enumbs-est 100 5 2 300 2 2 50 | tee lwechal-est-result/"enumbs(32+2gpus)-d4f-theo2.log" #{{80, 0.005}}
...
# ./lwechal-bssa-est 100 5 2 300 1 0 2 1 50 | tee lwechal-est-result/"bssa(32+2gpus)-d4f-theo2.log"

# ./lwechal-bssa-est 8 5 2 300 1 0 3 2 50 | tee lwechal-est-result/"bssa(32+2gpus)-d4f-theo2.log"
