...
mkdir "ideallatticechal-est-result"
...
g++ -O3 -funroll-loops -o ideallatticechal-enumbs-est ./asvp-est/ideallatticechal-enumbs-parallel-est.cpp  -L. -pthread -lfplll -lgmp -lmpfr -lest
...
./ideallatticechal-enumbs-est 100 1 2 300 5 3 50 2  | tee ideallatticechal-est-result/"enumbs(32+2gpus)-d4f-default-g6k-J=100-maxloop=1.log" 
