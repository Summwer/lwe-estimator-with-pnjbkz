...
def estimate_attack(silent=False, method=1, worst_case = False, progressive_sieve = True,parallel_ = False, l = None, dvol = None, dim_ = None, J=1, gap=1, J_gap = 1, cost_model = 1, gen_GSA_gso = True,print_l = False, b = None):
    ...
    if(method == 1):
        ...
        betamin, G, B = progressive_bkz_only(l, verbose=not silent, cost_model = cost_model, worst_case = worst_case)
    ...
    if(method == 2):
        ...
        betamin, G1, dsvp, dsvpmax, G, B, delta = two_step_mode_estimation( l, verbose=not silent, progressive_sieve = progressive_sieve, cost_model=cost_model, worst_case = worst_case)
    ...
    if(method == 3):
        ...
        betamin , G, B = bkz_only(dim_, dvol, l,verbose=not silent,cost_model=cost_model, worst_case = worst_case)
